...
folders = {"Images": [".jpeg", ".jpg", ".tiff", ".gif", ".bmp", ".png", ".bpg", "svg",
              ...
              ".msv", "ogg", "oga", ".raw", ".vox", ".wav", ".wma"], "Videos": [".avi", ".flv", ".wmv", ".mov", ".mp4", ".webm", ".vob", ".mng",
               ".qt", ".mpg", ".mpeg", ".3gp"], "Archives": [".a", ".ar", ".cpio", ".iso", ".tar", ".gz", ".rz", ".7z",
                 ".dmg", ".rar", ".xar", ".zip"], "PDF Files": ['.pdf'], "Python Files": ['.py', '.pyw', '.ipynb', '.pyc'], "Applications": ['.exe', '.app', '.apk'], "Documents": ['.doc', '.docx', '.docm', '.dot'], "Spreadsheets": ['.xls', '.xlsx', '.xlsm'], "Text Files": [".txt", ".in", ".out"], "Java Files": ['.class', '.java'], "C++ Files": ['.c', '.cpp'], "JSON Files": [".json"], "Presentations": [".ppt", ".pptm", ".pptx"], "Shortcuts" : [".lnk"]}
